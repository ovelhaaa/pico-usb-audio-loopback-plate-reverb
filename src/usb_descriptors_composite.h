...
#define TUD_AUDIO_MIDI_INTERFACE_DESC_LEN (TUD_AUDIO_DESC_IAD_LEN\
    ...
    + TUD_AUDIO_DESC_STD_AS_ISO_EP_LEN\
    + TUD_AUDIO_DESC_CS_AS_ISO_EP_LEN\
    + TUD_MIDI_DESC_STD_AC_LEN\
    + TUD_MIDI_DESC_CS_AC_LEN\
    + TUD_MIDI_DESC_STD_AS_LEN\
    + TUD_MIDI_DESC_CS_AS_LEN\
    + TUD_MIDI_DESC_JACK_DESC_LEN\
    + TUD_MIDI_DESC_JACK_DESC_LEN\
    + TUD_MIDI_DESC_STD_BULK_EP_LEN\
    + TUD_MIDI_DESC_CS_BULK_EP_LEN\
    + TUD_MIDI_DESC_STD_BULK_EP_LEN\
    + TUD_MIDI_DESC_CS_BULK_EP_LEN)

#define TUD_AUDIO_MIDI_INTERFACE_DESCRIPTOR(_stridx, _epout, _epin, _epint) \
